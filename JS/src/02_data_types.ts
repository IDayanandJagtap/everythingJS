...
let var1: any = "Can be of any data type ";
var1 = 32;

// Unknown : use instead of any;
let unk: unknown = "Safer option to any";

// Never : Not really used ;
let ne: never;

// Null and undefined:
let some: null = null; // These values can't be changed !
let some1: undefined;
...
// Objects
let obj1: { name: string; age: number; isStudent: boolean } = {
    name: "DJ",
    age: 20,
    isStudent: true,
};
